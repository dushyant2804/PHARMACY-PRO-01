...
async def list_medicines(
    ...
    if medicine_keys:
        ...
        for po in purchase_orders:
            po_distributor_name = (
                ...
                or distributor_lookup.get(po.get("distributor_id"))
                or ""
            )
    ...
    for m in items:
        ...
        distributor_name = (
            ...
            or distributor_lookup.get(distributor_id)
            or ""
        )
...
async def rebuild_inventory():
    ...
    distributor_docs = await db.distributors.find(
        {},
        {
            "_id": 0,
            "id": 1,
